...
<div class="product-price" id="productPrice<?php echo $this->product->virtuemart_product_id ?>">
	...
	if (!empty($this->product->prices['salesPrice'])) {
		//echo "<h5>" . JText::_ ('COM_VIRTUEMART_CART_PRICE') . "</h5>";
	}
	...
	echo '<div class="mainprice">'.$this->currency->createPriceDiv ('salesPrice', 'COM_VIRTUEMART_PRODUCT_SALESPRICE', $this->product->prices, false,false,1,true).'</div>';
	//createPriceDiv($name,$description,$product_price,$priceOnly=false,$switchSequel=false,$quantity = 1.0,$forceNoLabel=false);
