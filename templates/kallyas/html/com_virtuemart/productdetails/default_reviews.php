			...
			function check_reviewform() {
				...
				;(function($) {
					jQuery(window).load(function(){
						...
						//console.log(steps+'-'+boxWidth+'-'+starSize+'-'+ratingboxPos.left);
...
//]]>
			...
			if ($review_editable) {
				?>
				<p class="step"><?php echo JText::sprintf ('COM_VIRTUEMART_REVIEW_COMMENT', VmConfig::get ('reviews_minimum_comment_length', 100), VmConfig::get ('reviews_maximum_comment_length', 2000)); ?></p>
				<p>
				<textarea class="input-xxlarge" title="<?php echo JText::_ ('COM_VIRTUEMART_WRITE_REVIEW') ?>" class="inputbox" id="comment" onblur="refresh_counter();" onfocus="refresh_counter();" onkeyup="refresh_counter();" name="comment" rows="5" cols="60"><?php if (!empty($this->review->comment)) {
					echo $this->review->comment;
				} ?></textarea>
				</p>
				<p class="formfooter">
					<?php echo JText::_ ('COM_VIRTUEMART_REVIEW_COUNT') ?>
					<input type="text" value="0" size="4" class="vm-default input-mini" name="counter" maxlength="4" readonly="readonly"/>
