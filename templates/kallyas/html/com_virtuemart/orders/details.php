...
if($this->print){
	...
	?>
	<h1 class="page-title"><?php echo JText::_('COM_VIRTUEMART_ACC_ORDER_INFO'); ?>
	...
	$details_link = "<a href=\"javascript:void window.open('$details_url', 'win2', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');\" class=\"print_link\" data-rel=\"tooltip\" data-original-title=\"Print\" >";
	...
	$details_link .= '<span class="icon-print icon-white"></span>';
	$details_link  .=  '</a>';
	echo $details_link; ?>
</h1>
<?php if($this->order_list_link){ ?>
	<div class='spaceStyle'>
		...
		<a class="btn" href="<?php echo $this->order_list_link ?>"><?php echo JText::_('COM_VIRTUEMART_ORDERS_VIEW_DEFAULT_TITLE'); ?></a>
	    </div>
	    <div class="clear"></div>
	</div>
<?php }?>
