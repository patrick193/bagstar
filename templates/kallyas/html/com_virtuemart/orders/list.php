...
?>
<h1 class="page-title"><?php echo JText::_('COM_VIRTUEMART_ORDERS_VIEW_DEFAULT_TITLE'); ?></h1>
<?php
if (count($this->orderlist) == 0) {
 ...
 ?>
<div id="editcell">
	<table class="adminlist table" width="80%">
	<thead>
	<tr>
		<th>
	...
	<?php
		...
		foreach ($this->orderlist as $row) {
			...
			<tr class="<?php echo "row$k"; ?>">
				<td align="left">
					<strong><a href="<?php echo $editlink; ?>"><?php echo $row->order_number; ?></a></strong>
				</td>
				<td align="left">
