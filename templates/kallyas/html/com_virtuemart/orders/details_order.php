...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="list-orders table-striped">
    <tr>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="list-orders">
    <tr>
	<td valign="top" width="50%">
		<h4 class="m_title uppercase"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_BILL_TO_LBL') ?></h4>
	    <table border="0" class="table-striped" width="90%"><?php
	    foreach ($this->userfields['fields'] as $field) {
		if (!empty($field['value'])) {
		    echo '<tr><td class="key" width="50%">' . $field['title'] . '</td>'
		    . '<td width="50%">' . $field['value'] . '</td></tr>';
		}
	    }
	    ?></table>
	</td>
	<td valign="top" width="50%">
		<h4 class="m_title uppercase"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SHIP_TO_LBL') ?></h4>
	    <table border="0" class="table-striped" width="90%"><?php
