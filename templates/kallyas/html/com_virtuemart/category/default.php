...
//if (!class_exists( 'mod_virtuemart_product_hgcarousel' )) require_once dirname(__FILE__).'/../../..'.'/lib/helper.php';
if (!class_exists( 'mod_virtuemart_product_hgcarousel' )) require_once JPATH_SITE . DS . 'modules/mod_hg_vm_products_carousel/helper.php';
...
<?php if (!empty($this->keyword)) { ?>
	<h3 class="title"><?php echo $this->keyword; ?></h3>
<?php } ?>
...
<!--<div class="orderby-displaynumber">
	...
	<div class="row-fluid">
		...
		<div class="span4 display-number dropdown-select"><?php echo $this->vmPagination->getResultsCounter ();?><br/><?php echo $this->vmPagination->getLimitBox (); ?></div>
	</div>
	<div class="row-fluid">
		<div class="span12"><hr /></div>
	</div>
...
<h2 class="m_title"><?php echo $this->category->category_name; ?></h2>
	...
	<?php
		...
		<div class="product span<?php echo $Browsecellwidth; ?>">
			<div class="inner-item product-list-item uppercase">
				<span class="hover"></span>
				<div class="image">		
				...
				<div class="prod-details fixclear">
					<h3><a href="<?php echo $product->link ?>" title="<?php echo  $product->product_name ?>"><?php echo  $product->product_name; ?></a></h3>
					...
					<div class="actions">
                                            	<a class="ask-a-question btn btn-info" href="<?php echo $product->link ?>/askquestion?tmpl=component&amp;iframe=true&amp;width=700&amp;height=550" rel="prettyPhoto" ><?php echo JText::_('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL') ?></a>

						<?php // echo JHTML::link ($product->link, JText::_ ('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL'), array('title' => $product->product_name, 'class' => 'ask-a-question')); ?>
						<?php
					...
					<div class="price" id="productPrice<?php echo $product->virtuemart_product_id ?>">
						<?php
						if ($this->show_prices == '1') {
							if ($product->prices['salesPrice']<=0 and VmConfig::get ('askprice', 1) and  !$product->images[0]->file_is_downloadable) {
								echo '<p>'.JText::_ ('COM_VIRTUEMART_PRODUCT_ASKPRICE').'</p>';
							}
							/*
