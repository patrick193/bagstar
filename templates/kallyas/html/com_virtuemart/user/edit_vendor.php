	...
	<table class="admintable" width="100%">
		<tr>
			<td valign="top" width="50%">
				<fieldset class="haspad form-horizontal">
					<legend>
					...
					<table class="admintable">
						<tr>
							<td>
								<div class="control-group">
									<label class="control-label"><?php echo JText::_('COM_VIRTUEMART_STORE_FORM_STORE_NAME'); ?>:</label>
									<div class="controls">
						...
						<tr>
							<td>
								<div class="control-group">
									<label class="control-label"><?php echo JText::_('COM_VIRTUEMART_STORE_FORM_COMPANY_NAME'); ?>:</label>
									<div class="controls">
						...
						<tr>
							<td>
								<div class="control-group">
									<label class="control-label"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_FORM_URL'); ?>:</label>
									<div class="controls">
						...
						<tr>
							<td>
								<div class="control-group">
									<label class="control-label"><?php echo JText::_('COM_VIRTUEMART_STORE_FORM_MPOV'); ?>:</label>
									<div class="controls">
				...
				<fieldset class="haspad form-horizontal">
					...
					<table class="admintable">
						<tr>
							<td>
								<div class="control-group">
									<label class="control-label"><?php echo JText::_('COM_VIRTUEMART_CURRENCY'); ?>:</label>
									<div class="controls">
						...
						<tr>
							<td>
								<div class="control-group">
									<label class="control-label"><?php echo JText::_('COM_VIRTUEMART_STORE_FORM_ACCEPTED_CURRENCIES'); ?>:</label>
									<div class="controls">
		...
		<tr>
			<td colspan="2">
				<fieldset class="haspad form-horizontal vmcustomfields">
					<legend>
						<?php echo JText::_('COM_VIRTUEMART_VENDOR_FORM_INFO_LBL') ?>
					</legend>
