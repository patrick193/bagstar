...
//JHTML::script('vm2admin.js', JURI::root().'administrator/components/com_virtuemart/assets/js/'); // VM_THEMEURL
...
<form method="post" id="adminForm" name="userForm" action="<?php echo JRoute::_('index.php?view=user',$this->useXHTML,$this->useSSL) ?>" class="form-validate form-horizontal">

<h3 class="m_title upperCase"><?php if($this->userDetails->virtuemart_user_id==0) echo JText::_('COM_VIRTUEMART_YOUR_ACCOUNT_REG'); ?></h3><hr />
