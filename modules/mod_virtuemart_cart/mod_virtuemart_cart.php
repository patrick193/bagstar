...
$style = $params->get('modstyle','default');
...
if ($style == 'headercart') {
	$data->billTotal = $lang->_('TPL_KALLYAS_VIRTUEMART_CART_TOTAL').' <strong>'. $data->billTotal .'</strong>';
} else {
...
$cart_link = JRoute::_("index.php?option=com_virtuemart&view=cart".$taskRoute,$useXHTML,$useSSL);
...
/* Laod tmpl default */
require(JModuleHelper::getLayoutPath('mod_virtuemart_cart', $style));
?>