	...
	this.TabPane = new Class(
			{
				...
				initialize : function(container, options) {
					...
					if (Cookie.read("jltabactive")) {
						var jltba = Cookie.read("jltabactive");										
					} else {var jltba = 0;}
					
					
					this.tabs[jltba].addClass(this.options.activeClass);
					// hide all available contents:
					this.contents.setStyle('display', 'none');
					// show the content of the first tab:
					this.contents[jltba].setStyle('display', 'block');
					...
					this.container.addEvent('click:relay('
						...
						var ckvalue = this.tabs.indexOf(tab);
						Cookie.write("jltabactive",ckvalue,{duration: 30});
					}.bind(this));
