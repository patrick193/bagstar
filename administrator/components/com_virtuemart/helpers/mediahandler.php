...
'; 
			...
			jQuery(document).ready(function(){ if(jQuery.isFunction('vm2admin')) jQuery('#ImagesContainer').vm2admin('media','".$type."','0') }); " ;
			...
			if(jQuery.isFunction('searchMedia')) 
