...
?>
	...
	<script type="text/javascript">
		...
		<?php 
		//echo file_get_contents($GLOBALS['comp_path'].'js/pt.producttypes.js'); 
...
?>
	...
	<td class="ptp-rightData"><form method="get" action="<?php echo $GLOBALS['fajax'] ?>" name="parametersForm">
...
<table class="ptp-paramTbl">
 ...
 <tr><td class="titleCell"> </td><td colspan="2"><input type="checkbox" name="parameter_multiselect_<?php echo $key ?>" value="Y" id="id_parameter_multiselect_<?php echo $key ?>" />
