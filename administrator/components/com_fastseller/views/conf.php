...
?>
		...
		<td class="confopt-figure"><div id="show_unpublished_products_fig"<?php if(fsconf::getOption('show_unpublished_products')!='Y') echo ' class="semi-transparent"'; ?>><img src="<?php echo $comp_url ?>images/help/showunpub.png" width="311" height="35" /></div></td></tr>
		...
		<td class="confopt-figure"><div id="show_pdesc_button_fig"<?php if(fsconf::getOption('show_pdesc_button')!=1) echo ' class="semi-transparent"'; ?>><img src="<?php echo $comp_url ?>images/help/showpdesc.png" width="112" height="33" /></div></td></tr>
		...
		<td class="confopt-figure"><div style="margin:3px 0;"><img src="<?php echo $comp_url ?>images/help/defaultnumrows.png" width="221" height="62" /></div></td></tr>
		
		
		<tr><td class="confopt-num">6.</td>
		<td class="confopt-value">
			<label for="vm_lang" class="confopt-lbl">Override Virtuemart's lang value:</label>
			<input type="text" name="vm_lang" id="vm_lang" value="<?php echo fsconf::getOption('vm_lang') ?>" size="5" class="confopt-inpt" />
			<br/>
			<span style="font:11px Tahoma;">The suffix of #__virtuemart_products_&lt;lang&gt; table, e.g.: <i>en_gb</i> or <i>fr_fr</i></span>
		</td>
