	...
	public function saveParameters(){
		...
		foreach($keys as $key){
			...
			if(!$parameter_name_active){ // it's a new parameter
				...
				// mysql_real_escape_string($parameter_description)."', '$list_order', '$parameter_type', '".mysql_real_escape_string($defined_filters)."', '$parameter_multiselect', '', ".
				// "'".mysql_real_escape_string($parameter_unit)."', '$parameter_mode')";
				$q="INSERT INTO `#__vm_product_type_parameter` VALUES('$ptid', '$parameter_name', '$parameter_label', ".
